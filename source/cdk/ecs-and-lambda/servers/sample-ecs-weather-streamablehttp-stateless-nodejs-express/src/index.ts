 ...
 */
app.get(
  "/weather-nodejs/.well-known/oauth-protected-resource",
...
// Health check
app.get("/weather-nodejs/", async (req: Request, res: Response) => {
  res.status(200).json({
    status: "healthy",
    service: "weather-nodejs",
  });
});

// Apply authentication middleware to MCP endpoints
app.use("/weather-nodejs/mcp", authMiddleware);

app.post("/weather-nodejs/mcp", async (req: Request, res: Response) => {
...
app.get("/weather-nodejs/mcp", async (req: Request, res: Response) => {
...
app.delete("/weather-nodejs/mcp", async (req: Request, res: Response) => {
